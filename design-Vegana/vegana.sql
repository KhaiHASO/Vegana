...
-- ----------------------------
BEGIN;
INSERT INTO `customers` (`customerId`, `email`, `enabled`, `fullname`, `password`, `photo`, `roleId`) VALUES ('admin', 'adminvegana@gmail.com', b'1', 'Tôi là admin', '$2a$10$1iPiIh9Mw/8jFkmrTzVhs.CrY8rBMn1hWHVSw2NPn92hRTK4kYwHu', '', 1), ('khai00', 'khaikhai331@gmail.com', b'1', 'Phan Hoàng Khải ', '$2a$10$j.MEMT2MkdQTF8OJ59As2OTw4Nhaxg0cCBnscsxMpFwhHx1.72.6a', '', 0), ('khai11', 'khaixrkyz@gmail.com', b'1', 'phan hoang khai', '$2a$10$ITDgfCJRVqIMaXpxKL72rOZ/lLQg3.0jcMm3fypsxdIET2OKJGluK', '', 0), ('sonnika', 'sonnguyenhong382@gmail.com', b'1', 'nguyen hong son', '$2a$10$rFvjHR41HlhHgrk6zlrgX.x4fDJIRLi/9ufvb2AIFM4I23OqL7Xsa', '', 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `orderdetails` (`orderDetailId`, `discount`, `price`, `quantity`, `status`, `total_price`, `orderId`, `productId`) VALUES (56, NULL, 120, 1, 'Đang Chờ Xử Lý', 114, 42, 37), (57, NULL, 65, 1, 'Đang Chờ Xử Lý', 65, 43, 32), (58, NULL, 40, 1, 'Đang Chờ Xử Lý', 38, 43, 4), (59, NULL, 50, 1, 'Đang Chờ Xử Lý', 50, 43, 8), (60, NULL, 80, 1, 'Đang Chờ Xử Lý', 72, 43, 10), (61, NULL, 100, 1, 'Đang Chờ Xử Lý', 100, 43, 12), (62, NULL, 120, 1, 'Đang Chờ Xử Lý', 108, 43, 14);
COMMIT;
